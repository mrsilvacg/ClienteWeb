...
if(document.cadastro.newsSim.checked == false && document.cadastro.newsNao.checked == false){
...
if(document.cadastro.newsSim.checked == true && document.cadastro.newsNao.checked == false){
	alert("A qualquer momento voce pode cancelar o recebimento dos e-mails de promoção\
