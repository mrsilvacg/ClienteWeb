		...
		if(document.cadastro.senha.value == ""
		  ...
		  return true; 
			...
			function validaMsg(){
				...
				if(document.cadastro.newsSim.checked  && document.cadastro.newsNao.checked || 
					...
					alert("Campo Obrigatório - Escolha Sim ou Não");
								...
								if(document.cadastro.newsSim.checked == true  && document.cadastro.newsNao.checked == true){
			...
			function validaObservacao(){
			   ...
			   var TextMsg = document.cadastro.observacao.value;
			   ...
			   return false;
				...
				var vcpf = document.cadastro.cpf.value;
